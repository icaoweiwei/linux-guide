# -*- coding: utf-8 -*-
#
# linuxguide documentation build configuration file, created by
...
html_theme_options = {
    ...
    'github_user': 'icaoweiwei',
    'github_repo': 'linux-guide',
    'github_banner': True,
    'show_related': False
}
...
man_pages = [
    ('index', 'linuxguide', u'Linux Guide Documentation',
     [u'CaoWeiwei'], 1)
]
...
epub_author = u'CaoWeiwei'
epub_publisher = u'CaoWeiwei'
epub_copyright = u'2017, CaoWeiwei'
